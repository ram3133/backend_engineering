...
switch ($profile) {
  ...
  "backend-all-companies" {
    ...
    $rejectPattern = 'intern|principal|director|manager|architect|training course|certification|question paper|walkin|walk-in|bpo|support|customer support|sales|account executive|front end|frontend|ui engineer|ux|manual testing|qa automation|selenium'
    $roleBoostKeywords = @("backend engineer","backend developer","software engineer backend","backend software engineer","platform engineer","api engineer","java engineer","spring boot engineer","distributed systems engineer","full stack backend")
    $stackBoostKeywords = @("java","core java","spring boot","rest api","microservices","sql","junit","mockito","jdbc","postman","swagger","sonarqube","git","copilot")
    $platformBoostKeywords = @("rest apis","api development","service oriented","event driven","backend systems","full stack")
    $cloudBoostKeywords = @("docker","kubernetes","aws","azure","ci/cd","maven","gradle","sonarqube","git","github","gitlab")
    $locationPattern = 'bengaluru|bangalore|hyderabad|kochi|pune|chennai|gurugram|noida|mumbai|ahmedabad|indore|kolkata|jaipur|india|india remote|remote india'
    $linkedInSearches = @(
      [ordered]@{ name = "Bengaluru Java Backend"; role = "Java Backend Engineer"; location = "Bengaluru, Karnataka, India"; url = "https://www.linkedin.com/jobs/search/?keywords=Java%20Backend%20Engineer%20Spring%20Boot&location=Bengaluru%2C%20Karnataka%2C%20India&f_E=$profileMinYears&f_TPR=r604800"; cadence = "Daily"; lane = "LinkedIn Discovery" },
      [ordered]@{ name = "Hyderabad Java Backend"; role = "Java Backend Engineer"; location = "Hyderabad, Telangana, India"; url = "https://www.linkedin.com/jobs/search/?keywords=Java%20Backend%20Engineer%20Spring%20Boot&location=Hyderabad%2C%20Telangana%2C%20India&f_E=$profileMinYears&f_TPR=r604800"; cadence = "Daily"; lane = "LinkedIn Discovery" },
      [ordered]@{ name = "India Remote Java Backend"; role = "Backend Engineer"; location = "India Remote"; url = "https://www.linkedin.com/jobs/search/?keywords=Java%20Backend%20Engineer%20SQL%20Microservices&location=India&f_E=$profileMinYears&f_TPR=r604800&f_WT=2%2C3"; cadence = "Daily"; lane = "LinkedIn Discovery" },
      [ordered]@{ name = "India Remote Platform Engineer"; role = "Platform Engineer"; location = "India Remote"; url = "https://www.linkedin.com/jobs/search/?keywords=Platform%20Engineer%20Java%20Microservices&location=India&f_E=$profileMinYears&f_TPR=r604800&f_WT=2%2C3"; cadence = "Daily"; lane = "LinkedIn Discovery" },
      [ordered]@{ name = "India Remote Backend Developer"; role = "Backend Developer"; location = "India Remote"; url = "https://www.linkedin.com/jobs/search/?keywords=Backend%20Developer%20Java%20Spring%20Boot&location=India&f_E=$profileMinYears&f_TPR=r604800&f_WT=2%2C3"; cadence = "Daily"; lane = "LinkedIn Discovery" }
    )
    $broadDiscoveryQueries = @(
